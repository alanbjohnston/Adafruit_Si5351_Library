 ...
 * Channel 2: 0  MHz
 */
static const uint8_t bpsk_si5351_regs_15to92_149to170[100][2] = {
    ...
    {16, 0x4F}, /* CLK0 Control: 8mA drive, Multisynth 0 as CLK0 source, Clock
                   ...
                   clock powered up */
    {17, 0x5F}, /* CLK1 Control: 8mA drive, Multisynth 1 as CLK1 source, Clock
...
static const uint8_t bpsk_15k_si5351_regs_15to92_149to170[100][2] = {
    {15, 0x00}, /* Input source = crystal for PLLA and PLLB */
    {16, 0x4F}, /* CLK0 Control: 8mA drive, Multisynth 0 as CLK0 source, Clock
                   not inverted, Source = PLLA, Multisynth 0 in integer mode,
                   clock powered up */
...
static const uint8_t fsk_15k_si5351_regs_15to92_149to170[100][2] = {
    {15, 0x00}, /* Input source = crystal for PLLA and PLLB */
    {16, 0x6F}, /* CLK0 Control: 8mA drive, Multisynth 0 as CLK0 source, Clock
                   not inverted, Source = PLLA, Multisynth 0 in integer mode,
                   clock powered up */
...
public:
  ...
  err_t_ setClockBPSK(int freq_offset);       //!< @return ERROR_NONE
  err_t_ setClockFSK(int freq_offset);       //!< @return ERROR_NONE    
